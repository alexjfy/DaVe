...
class output_generator;
  ...
  function new(mailbox gen2driv,event ended);
    //getting the mailbox handle from env, in order to share theoutput_transaction packet between the generator and driver, the same mailbox is shared between both.
  ...
  //main task, generates(create and randomizes) the repeat_count number of output_transaction packets and puts into mailbox
  task main();
